...
QtObject {
    property Component fullScreenRequestComponent: Component {
        QtObject {
            ...
            function accept() {
                if (__webview.backend == "QtWebEngine")
                    __request.accept();
                else if (__webview.backend == "Oxide")
    ...
    property Component downloadRequestComponent: Component {
        QtObject {
            ...
            function accept() {
                var download;
                if (__profile.backendName == "QtWebEngine") {
    ...
    function getFullScreenRequest(webview, toggleOn, request) {
        return fullScreenRequestComponent.createObject(null, {"__webview": webview, "__request": request, "toggleOn": toggleOn});
    }
    ...
    function getFeatureRequest(webview, origin, feature, __feature, request) {
        return featureRequestComponent.createObject(null, {"__webview": webview, "__request": request, "origin": origin, "feature": feature, "__feature": __feature});
    }

    function getDownloadRequest(profile, request, component, mimeType) {
        return downloadRequestComponent.createObject(null, {"__profile": profile, "__request": request, "__component": component, "mimeType": mimeType})
    }
}
